...
本目录保存当前 AgentHub 应用真实可执行的用户操作、开发和维护指南。指南必须与当前代码、入口和跨平台支持状态保持一致，不能把历史原型或已删除应用写成可运行功能。
...
- [SkillBridge 迁移记录](../modules/capabilities/references/skill-bridge-migration.md)
